...
//  A- HTML inside index.html (button onclick = "console.log('html clickin!')")
//  B- The DOM's element.onclick attribute
launchButton.onclick = function(event){
    console.log("Only thing is... only one click per element..overwrites anything in html.");
}
//  C- element.addEventListener('click', callback)
//takes in two arguments!! what to listen for, and what to do.
...
//Two ways to declare function in JS
//Function Expression ::: const named = function(){} -> NOT Hoisted
//Function Declaration ::: function named() {} -> hoisted
